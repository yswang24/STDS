...
> 生成时间:2026-07-17
> 数据来源:stms.db (566 条 stds_record, 62 chartcode, 3320 formula 行)
...
| `EST C00` | 3 | 估算码(EST=Estimate) |
| `EST V00` | 2 | 估算码 |
| `201 020` | 1 | 可能是拼写错误(应为 `202 010`?) |

**合计**:28 条,占 566 条的 4.9%
...
| 孤儿码 | 28 条(4.9%) | unresolved + 复核 |
| 空码 | 84 条(14.8%) | unresolved + 复核 |
| 公式残留 '=' | 0 条 | 防护在位 |
| 明文凭据 | 0 处 | 配置外置 |
| SQL 注入 | 0 处 | 全部参数化 |

**脏数据占比**:28 + 84 = 112 条(19.8%)需人工复核。剩余 454 条可自动化处理。
